...
Figure plane(int length, int divisions) {
    Figure fig;
    fig = Figure();
    ...
    for (int i = 0; i < divisions; i++) {
        for (int j = 0; j < divisions; j++) {
            ...
            fig.addVertex(x1, 0, z1);
            fig.addVertex(x2, 0, z1);
            fig.addVertex(x1, 0, z2);
            fig.addVertex(x2, 0, z2);
