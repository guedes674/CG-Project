...
# Generator files
GENERATOR_SRC_FILES = src/generator/generator.cpp src/generator/model.cpp src/aux/aux.cpp src/generator/plane.cpp src/generator/box.cpp src/generator/sphere.cpp src/generator/cone.cpp
